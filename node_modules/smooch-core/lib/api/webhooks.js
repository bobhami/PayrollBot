...
var WebhooksApi = exports.WebhooksApi = function (_BaseApi) {
  ...
  WebhooksApi.prototype.list = function list() {
    ...
    return this.validateAuthHeaders().then(function (authHeaders) {
      return (0, _http.http)('GET', url, {}, authHeaders);
    });
  };
  ...
  WebhooksApi.prototype.create = function create(props) {
    ...
    var url = this.getFullURL('webhooks');
    return this.validateAuthHeaders().then(function (authHeaders) {
      return _this2.validateProps(props, true).then(function (validatedProps) {
        return (0, _http.http)('POST', url, validatedProps, authHeaders);
      });
    });
  };
  ...
  WebhooksApi.prototype.update = function update(webhookId, props) {
    ...
    var url = this.getFullURL('webhooks', webhookId);
    return this.validateAuthHeaders().then(function (authHeaders) {
      return _this3.validateProps(props).then(function (validatedProps) {
        return (0, _http.http)('PUT', url, props, authHeaders);
      });
    });
  };
  ...
  WebhooksApi.prototype.delete = function _delete(webhookId) {
    var url = this.getFullURL('webhooks', webhookId);
    return this.validateAuthHeaders().then(function (authHeaders) {
      return (0, _http.http)('DELETE', url, undefined, authHeaders);
    });
  };
