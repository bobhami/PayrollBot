...
var Smooch = exports.Smooch = function (_SmoochBase) {
  ...
  function Smooch() {
    ...
    var _this = (0, _possibleConstructorReturn3.default)(this, _SmoochBase.call(this, auth, serviceUrl));

    _this.webhooks = new _webhooks.WebhooksApi(_this.serviceUrl, _this.authHeaders);
